...
b.shape                   	# (4,)各维数量
b.argmax()               	# 3 np.argmax(b,axis=n) n轴最大值索引
...
array([[[ 0,  1,  2,  3],
       ...
       [[12, 13, 14, 15],
        ...
        [20, 21, 22, 23]]])
'''
a = np.arange(24).reshape((2, 3, 4))	#reshape((tuple))
b = a[1][1][1]  # 17 与列表操作类似
